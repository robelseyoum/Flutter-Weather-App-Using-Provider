...
▹ During the decoding of the JSON data, we are comparing the current time to the sunrise
  and sunset times to determine if it is day or night at the location.
 */
class Forecast {
